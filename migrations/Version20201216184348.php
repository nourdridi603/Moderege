 ...
 */
final class Version20201216184348 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sondage CHANGE enqueteur_id enqueteur_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sondage CHANGE enqueteur_id enqueteur_id INT DEFAULT NULL');
    }
}
